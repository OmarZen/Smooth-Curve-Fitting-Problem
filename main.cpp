...
//    // Perform tournament selection
//    for (int i = 0; i < population.size(); i++) {
//        vector<chromosome> tournament(tournamentSize);
//
//        // Choose n individuals randomly
//        for (int j = 0; j < tournamentSize; j++) {
//            int randomIndex = rand() % population.size();
...
//        }
//
//        // Sort the tournament participants based on fitness
//        sort(tournament.begin(), tournament.end(), [](const chromosome &a, const chromosome &b) {
//            return a.fitness < b.fitness;
//        });
//
//        // Pick the one with the highest fitness
//        winners.push_back(tournament[0]);
//    }
//
//    // Replace the original population with the winners
//    population = winners;
